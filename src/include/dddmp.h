...
EXTERN int Dddmp_cuddHeaderLoad(Dddmp_DecompType *dd_type, int *nVars, int *nsuppvars, int *nRoots, char ***orderedVarNames, char ***suppVarNames, int **varIds, char *file, FILE *fp);
...
EXTERN int Dddmp_cuddHeaderLoadCnf(int *nVars, int *nsuppvars, int *nRoots, char ***orderedVarNames, char ***suppVarNames, int **varIds, char *file, FILE *fp);
...
EXTERN int Dddmp_cuddBddStoreCnf(DdManager *ddMgr, DdNode *f, Dddmp_DecompCnfStoreType mode, char **varNames, int *bddIds, int *bddAuxIds, int *cnfIds, int idInitial, int edgeInTh, int pathLengthTh, char *fname, FILE *fp, int *varNewNPtr);
EXTERN int Dddmp_cuddBddArrayStoreCnf(DdManager *ddMgr, DdNode **f, int rootN, Dddmp_DecompCnfStoreType mode, char **varNames, int *bddIds, int *bddAuxIds, int *cnfIds, int idInitial, int edgeInTh, int pathLengthTh, char *fname, FILE *fp, int *varNewNPtr);
